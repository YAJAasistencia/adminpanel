      ...
      <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }}
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="bg-slate-50 rounded-2xl p-4 space-y-3">
            ...
            <div className="flex justify-between text-sm"><span className="text-slate-500">Fecha</span><span className="font-semibold text-slate-900">{formatCDMX(ride.requested_at || ride.created_date, "shortdatetime")}</span></div>
          </div>
                ...
                <button key={ride.id}
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-slate-300 mt-1 flex items-center gap-1"><Clock className="w-3 h-3" />{formatCDMX(ride.requested_at || ride.created_date, "shortdatetime")}</p>
                    </div>
