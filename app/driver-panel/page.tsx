...
export default function DriverApp() {
  ...
  const [sessionLoading, setSessionLoading] = useState(() => !!localStorage.getItem(SESSION_KEY));
  ...
  return (
    ...
    >
      <AnnouncementModal audience="drivers" cityId={driver?.city_id} storageKey="driver_shown_announcements" />
      <IncomingRideAlert
        ride={incomingRide}
        driver={driver}
        settings={settings}
